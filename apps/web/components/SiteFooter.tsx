      ...
      <div className="soft-card p-3 md:p-4">
        <div className="grid gap-2 md:grid-cols-2 xl:grid-cols-5">
          ...
          <div>
            ...
            <div className="mt-0.5 text-sm text-[var(--ink)] space-y-1">
        ...
        <div className="mt-1 pt-1 border-t border-black/10 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
