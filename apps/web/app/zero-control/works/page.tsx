          ...
          {works.map((work) => (
            <article key={work._id} className="soft-card relative overflow-hidden group">
              ...
              <button
                ...
                className="absolute top-3 right-3 p-2 bg-white/90 backdrop-blur text-red-600 rounded-md opacity-0 group-hover:opacity-100 transition shadow-sm hover:bg-red-50"
                title="Delete Work"
              >
                <Trash2 size={16} />
              </button>
