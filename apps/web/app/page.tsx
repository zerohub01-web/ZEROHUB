            ...
            {done ? (
              ...
              <form action={handleBooking} className="grid gap-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <input aria-label="Email Address" name="email" type="email" required placeholder="Work email" className="field py-3" />
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <select aria-label="Team size" name="teamSize" className="field py-3" defaultValue="">
