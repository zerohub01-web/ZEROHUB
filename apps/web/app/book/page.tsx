        ...
        <div className="soft-card p-6 md:p-8 mt-8">
          {done ? (
            ...
            <form action={handleBooking} className="grid gap-4">
              <input aria-label="Full Name" name="name" required placeholder="Full name" className="field py-3" />
              <div className="grid md:grid-cols-2 gap-4">
                <input aria-label="Email Number" name="email" type="email" required placeholder="Work email" className="field py-3" />
                <input aria-label="Phone number" name="phone" required placeholder="Phone number" className="field py-3" />
              </div>
              <input aria-label="Business Type" name="businessType" required placeholder="Business Type & Industry" className="field py-3" />
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <select aria-label="Team Size" name="teamSize" className="field py-3" defaultValue=""><option value="" disabled>Team size</option><option value="1-10">1-10</option><option value="11-50">11-50</option><option value="51-200">51-200</option><option value="200+">200+</option></select>
                <select aria-label="Service Type" name="service" required className="field py-3">
